...
def get_reading():
    ...
    data = f"{power_laser:.2f}, {power_opc:.2f}, {temp_laser:.2f}, {temp_opc:.2f}\n"
...
# Start listening for commands for init and whatnot
listen_for_commands()

# CONSTANTLY SEND GET_READING TO COMPUTER FOR GRAPHING
while True:
    get_reading()
    sleep(1)
